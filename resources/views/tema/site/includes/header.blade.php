    	...
    	<div class="header-upper">
        	<div class="auto-container">
            	<div class="clearfix">
                    ...
                    <!--Logo-->
                    <div class="logo-box">
                        <div class="logo"><a href="{{asset('site.home')}}" title="CharityPro"><img src="images/logo-3.png" alt="CharityPro" title="CharityPro"></a></div>
                    </div>
        ...
        <div class="sticky-header">
            <div class="auto-container clearfix">
                ...
                <div class="logo pull-left">
                    <a href="index.html" class="img-responsive" title="CharityPro"><img src="images/logo-small.png" alt="CharityPro" title="CharityPro"></a>
                </div>
